...
create table registrars (id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), job_number varchar(255), primary key (id)) engine=InnoDB;
create table types (id bigint not null auto_increment, name varchar(255), primary key (id)) engine=InnoDB;
create table visits (id bigint not null auto_increment, date date, description varchar(255), registrar_job_number varchar(255), cloth_id bigint, primary key (id)) engine=InnoDB;
